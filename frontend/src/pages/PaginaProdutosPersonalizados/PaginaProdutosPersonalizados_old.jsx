...
const PaginaProdutosPersonalizados = () => {
  ...
  const renderizarPreview = () => {
    ...
    const getIconeProduto = (id) => {
      if (id.includes('caderno')) return '�';
      if (id.includes('agenda')) return '�';
      if (id.includes('bloco')) return '�️';
      if (id.includes('planner')) return '�';
      if (id.includes('calendario')) return '�';
      if (id.includes('etiquetas')) return '🏷️';
      return '�';
    };
                  ...
                  <Card.Body className="p-3">
                    <div className="d-flex align-items-center">
                      <div className="produto-thumb me-3 d-flex align-items-center justify-content-center">
                        {produto.id.includes('caderno') && '�'}
                        {produto.id.includes('agenda') && '�'}
                        {produto.id.includes('bloco') && '�️'}
                        {produto.id.includes('planner') && '�'}
                        {produto.id.includes('calendario') && '�'}
                        {produto.id.includes('etiquetas') && '🏷️'}
                      </div>
                ...
                <>
                  ...
                  <div className="preco-final mb-3">
                    <h5 style={{color: 'var(--primary-color)'}}>
                      💰 Total: R$ {Number(precoFinal || 0).toFixed(2)}
                    </h5>
                  </div>
